                ...
                <li>
                    <div align="center" style="background-color: black;">
                        <form method="post" action="SearchedProduct.php">
                            <input type="text" name="item" id="search_text" onkeyup="suggest(this)" placeholder="Serach.." value="<?php echo $item;?>" class=""><input type="submit" name="search" value="Search" class="button">
                        </form>
