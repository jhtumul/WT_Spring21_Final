<?php
    ...
    function insertUser($name,$username,$password,$email,$phone_no,$type)
    {
        $retype="";
        if($type=="user")
        {
        ...
        $query = "insert into users values(null,'$name','$username','$password','$email','$phone_no','$retype','null','null','null','$$$')";
        execute($query);
    }
    ...
    if(isset($_POST["register"]))
    {
        ...
        if(!$has_error)
        {
            ...
            if(isset($_POST["register"]))
            {
                insertUser($name,$uname,$pass,$email,$number,$type);
