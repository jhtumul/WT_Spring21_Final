    ...
    <body>
        <div class="login-div" align="center">
            ...
            <form action="" method="POST">
                <table align="center">
                    <tr>
                        <td colspan="2"><input type="text" id="username" name="uname" value="<?php echo $uname;?>" placeholder="Username" class="my-font my-textfield">
                        <br><span class="err-msg"><?php echo $err_uname;?></span><span id="err_username"></span></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td colspan="2"><input type="password" id="password" name="pass" value="<?php echo $pass;?>" placeholder="Password" class="my-font my-textfield">
